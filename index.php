...
body {
  ...
  min-height:0vh; color:black; background-color:#000000;
}
.btn {
  -moz-appearance: none;
  cursor: pointer;
...
.third {
  border-color: White;
  color: white;
  box-shadow: 0 0 40px 40px black inset, 0 0 0 0 White;
...
<center>
<h7>
<b style="color:white">Current versi GUI 1.0 Copyright &copy</b>
</h7>
</center>
</html>
